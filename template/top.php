        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-lg-6 ml-auto d-flex">
            <div class="ml-md-auto top-social d-none d-lg-inline-block">
              <a href="beranda.php" class="d-inline-block p-3">Beranda</a>
                <a href="artikel.php" class="d-inline-block p-3">Artikel</a>
                <a href="profil.php" class="d-inline-block p-3">My Profil</a>
            </div>
